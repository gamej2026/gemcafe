...
namespace GemCafe.Crafting
{
    public class HoldInputArea : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
    {
        ...
        // 誘몃땲寃뚯엫 ?룞?븞 ?쟾泥? ?솕硫? ?뼱?뵒瑜? ?꽣移섑빐?룄 ?엯?젰?릺?룄濡?, ?엯?젰 ?쁺?뿭?쓣 ?삎?젣 以?
        // 留? ?븵?쑝濡? ?삱?젮 ?듃?옓/?봽濡쒓렇?젅?뒪/二쇱쟾?옄 ?벑 ?떎瑜? 洹몃옒?뵿?씠 ?꽣移섎?? 媛?濡쒖콈吏?
        // ?븡寃? ?븳?떎. 誘몃땲寃뚯엫?씠 ?걹?굹硫? ?썝?옒 ?닚?꽌濡? ?릺?룎?젮 ?떎?쓬 ?떒怨?(二쇱쟾?옄 ?겢由? ?벑)瑜?
        // 諛⑺빐?븯吏? ?븡?뒗?떎.
