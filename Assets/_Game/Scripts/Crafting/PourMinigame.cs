...
namespace GemCafe.Crafting
{
    public class PourMinigame : MonoBehaviour
    {
        ...
        [Tooltip("각 스프라이트에서 다음 스프라이트로 넘어가기까지의 대기 시간(초). 비어 있거나 0 이하면 기본 대기시간을 사용한다.")]
        ...
        private void Update()
        {
            ...
            // 모바일 프레임 hitch로 hold 누적 시간이 급증하면 한 프레임에 상태가 과도하게 진행될 수 있다.
